...
<head>
    ...
    <title>Our Services - iTechnism | QA, Development, Data Extraction, RPA & Digital Marketing</title>
    <meta name="description" content="Comprehensive technology services including Software QA, Development, Data Extraction, RPA, and Digital Marketing. Expert solutions for your business needs.">
    ...
    <div class="py-16">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center mb-16">
                <h1 class="text-4xl font-bold text-gray-900 mb-4">Our Technology Services</h1>
                <p class="text-xl text-gray-600 max-w-3xl mx-auto">Comprehensive technology solutions including Software QA, Development, Data Extraction, RPA, and Digital Marketing services.</p>
            </div>
            ...
            <div class="mb-16">
                <div class="flex items-center mb-8">
                    ...
                    <div>
                        <h2 class="text-2xl font-bold text-gray-900">Software Quality Assurance</h2>
                        <p class="text-gray-600">Comprehensive testing services to ensure software quality and reliability</p>
                    </div>
                </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                    ...
                    <div class="bg-white rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 overflow-hidden group" data-aos="fade-up" data-aos-delay="300">
                        <div class="p-6">
                            <div class="w-12 h-12 bg-gradient-to-r from-blue-500 to-indigo-600 rounded-lg flex items-center justify-center mb-4 group-hover:scale-110 transition-transform duration-300">
                    ...
                    <div class="bg-white rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 overflow-hidden group" data-aos="fade-up" data-aos-delay="400">
                        <div class="p-6">
                            <div class="w-12 h-12 bg-gradient-to-r from-blue-500 to-indigo-600 rounded-lg flex items-center justify-center mb-4 group-hover:scale-110 transition-transform duration-300">
                    ...
                    <div class="bg-white rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 overflow-hidden group" data-aos="fade-up" data-aos-delay="500">
                        <div class="p-6">
                            <div class="w-12 h-12 bg-gradient-to-r from-blue-500 to-indigo-600 rounded-lg flex items-center justify-center mb-4 group-hover:scale-110 transition-transform duration-300">
            ...
            <div class="mb-16">
                <div class="flex items-center mb-8">
                    ...
                    <div>
                        <h2 class="text-2xl font-bold text-gray-900">Data Extraction Services</h2>
                        <p class="text-gray-600">Professional data extraction and web scraping solutions</p>
                    </div>
                </div>
            ...
            <div class="mb-16">
                <div class="flex items-center mb-8">
                    ...
                    <div>
                        <h2 class="text-2xl font-bold text-gray-900">Software Development</h2>
                        <p class="text-gray-600">Custom software development solutions for all platforms</p>
                    </div>
                </div>
            ...
            <div class="mb-16">
                <div class="flex items-center mb-8">
                    ...
                    <div>
                        <h2 class="text-2xl font-bold text-gray-900">RPA Services</h2>
                        <p class="text-gray-600">Robotic Process Automation solutions for business efficiency</p>
                    </div>
                </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    <div class="bg-white rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 overflow-hidden group" data-aos="fade-up">
                        <div class="p-6">
                            <div class="w-12 h-12 bg-gradient-to-r from-orange-500 to-red-600 rounded-lg flex items-center justify-center mb-4 group-hover:scale-110 transition-transform duration-300">
                    ...
                    <div class="bg-white rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 overflow-hidden group" data-aos="fade-up" data-aos-delay="300">
                        <div class="p-6">
                            <div class="w-12 h-12 bg-gradient-to-r from-orange-500 to-red-600 rounded-lg flex items-center justify-center mb-4 group-hover:scale-110 transition-transform duration-300">
                                <i class="fas fa-microsoft text-white text-lg"></i>
                            </div>
            ...
            <div class="mb-16">
                <div class="flex items-center mb-8">
                    ...
                    <div>
                        <h2 class="text-2xl font-bold text-gray-900">Digital Marketing</h2>
                        <p class="text-gray-600">Comprehensive digital marketing solutions to grow your business</p>
                    </div>
                </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                    ...
                    <div class="bg-white rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 overflow-hidden group" data-aos="fade-up" data-aos-delay="600">
                        <div class="p-6">
                            <div class="w-12 h-12 bg-gradient-to-r from-red-500 to-pink-600 rounded-lg flex items-center justify-center mb-4 group-hover:scale-110 transition-transform duration-300">
                    ...
                    <div class="bg-white rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 overflow-hidden group" data-aos="fade-up" data-aos-delay="700">
                        <div class="p-6">
                            <div class="w-12 h-12 bg-gradient-to-r from-red-500 to-pink-600 rounded-lg flex items-center justify-center mb-4 group-hover:scale-110 transition-transform duration-300">
                                <i class="fas fa-chart-bar text-white text-lg"></i>
                            </div>
                    ...
                    <div class="bg-white rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 overflow-hidden group" data-aos="fade-up" data-aos-delay="800">
                        <div class="p-6">
                            <div class="w-12 h-12 bg-gradient-to-r from-red-500 to-pink-600 rounded-lg flex items-center justify-center mb-4 group-hover:scale-110 transition-transform duration-300">
                    ...
                    <div class="bg-white rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 overflow-hidden group" data-aos="fade-up" data-aos-delay="900">
                        <div class="p-6">
                            <div class="w-12 h-12 bg-gradient-to-r from-red-500 to-pink-600 rounded-lg flex items-center justify-center mb-4 group-hover:scale-110 transition-transform duration-300">
